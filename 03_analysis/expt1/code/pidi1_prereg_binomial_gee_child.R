...
expt1_first_180_test_child_gee <- expt1_first_180_test_child %>%
  filter(!is.na(age_exact)) %>% 
  arrange(id, trial_order)

expt1_first_180_test_child_results <- geeglm(
  ...
  id = new_id, 
  corstr = "exchangeable")
summary(expt1_first_180_test_child_results)
expt1_first_180_test_child_anova <- anova(expt1_first_180_test_child_results)
expt1_first_180_test_child_anova
